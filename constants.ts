...
export const DEFAULT_CATEGORIES = ['Books', 'Stationery', 'Online Subscriptions', 'Food', 'Travel', 'Pocket Money', 'Snacks', 'Other'];
export const COLORS = ['#ef4444', '#f59e0b', '#3b82f6', '#8b5cf6', '#10b981', '#ec4899', '#14b8a6', '#6366f1'];
